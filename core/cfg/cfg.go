...
var Default = &Data{
	...
	Keybindings: map[string]string{
		...
		"entry.select_best_match":         "Alt+Return",
		"entry.log_qso":                   "Ctrl+Return",
		"entry.start_parrot":              "Ctrl+F1",
		"entry.enable_esm":                "Ctrl+Shift+M",
		"entry.next_esm_step":             "",
		...
		"entry.clear_vfo1":                "",
		"entry.clear_vfo2":                "",
		"radio.incremental_tuning_toggle": "Ctrl+Shift+X",
		"radio.incremental_tuning_up":     "Alt+Shift+Up",
		"radio.incremental_tuning_down":   "Alt+Shift+Down",
		"radio.xit_active":                "",
		"radio.xit_up":                    "",
		"radio.xit_down":                  "",
		"radio.rit_active":                "",
		"radio.rit_up":                    "",
		"radio.rit_down":                  "",
		"radio.frequency_up":              "Alt+Up",
		"radio.frequency_down":            "Alt+Down",
		"radio.dial_active":               "",
		"bandmap.mark":                    "Ctrl+M",
		"bandmap.delete_marker":           "Ctrl+Shift+D",
		...
		"bandmap.goto_cq_frequency":       "Ctrl+Shift+C",
		...
		"keyer.speed_up":                  "Ctrl+Alt+Up",
		"keyer.speed_down":                "Ctrl+Alt+Down",
	},
	SpotLifetime: "10m",
	SpotSources: []core.SpotSource{
		{
			Name:        "SDRainer",
			HostAddress: "localhost:35369",
			Type:        core.SkimmerSpot,
			Protocol:    core.SDRainerProtocol,
		},
		{
			Name:        "Skimmer",
			Username:    "dl0abc",
