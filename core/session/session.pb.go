...
const file_session_proto_rawDesc = "" +
	"\n" +
	"\rsession.proto\x12\asession\"\x87\x01\n" +
	"\x05State\x12#\n" +
	"\rlast_filename\x18\x01 \x01(\tR\flastFilename\x12)\n" +
	"\x11send_spots_to_tci\x18\x02 \x01(\bR\x0esendSpotsToTci\x12\x16\n" +
	"\x06radio1\x18\x03 \x01(\tR\x06radio1\x12\x16\n" +
	"\x06keyer1\x18\x04 \x01(\tR\x06keyer1B\x0eZ\fcore/sessionb\x06proto3"
