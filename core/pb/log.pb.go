...
type Contest struct {
	...
	QsosGoal                int32    `protobuf:"varint,22,opt,name=qsosGoal,proto3" json:"qsosGoal,omitempty"`
	PointsGoal              int32    `protobuf:"varint,23,opt,name=pointsGoal,proto3" json:"pointsGoal,omitempty"`
	MultisGoal              int32    `protobuf:"varint,24,opt,name=multisGoal,proto3" json:"multisGoal,omitempty"`
	SprintOperation         bool     `protobuf:"varint,25,opt,name=sprintOperation,proto3" json:"sprintOperation,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}
...
var fileDescriptor_a153da538f858886 = []byte{
	...
	,
}
